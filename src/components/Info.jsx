    ...
    return(
        <InfoContainer>
            <Column>
                ...
                <InfoText>Put your Farm Token to work.</InfoText>
                ...
                <div className='relativeContainer centerFlex'>
                    <HarvestProjects>
                        <div className='relativeContainer'>
                            ...
                            {
                                projects.map(({name, imgUrl, vector, dimensions, background, position}) =>
                                    <div key={name} style={{...position[0], position: 'absolute'}}>
                                        <div className='relativeContainer'>
                                            <HarvestProject>
                                                <Icon className='centerFlex' style={background}>
                                                    <LazyImg src={`/projects/${imgUrl}`} {...dimensions.img} alt={name}/>
                                                </Icon>
                                                {name}
                                            </HarvestProject>
                                            <Vector style={{...position[1], ...dimensions.vector}}>
                                                <LazyImg src={`/projects/${vector}`} {...dimensions.vector} alt="vector"/>
                                            </Vector>
                                        </div>
                                    </div>
                                )
